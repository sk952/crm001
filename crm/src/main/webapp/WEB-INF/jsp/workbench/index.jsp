	...
	<script type="text/javascript">
		...
		$(function(){
			...
			/*
                ...
                window.open：打开一个窗口（页面）
                参数1：打开的是哪张页面
                        需要将页面修改为jsp
                        将访问方式修改为访问后台，通过请求转发到该页面
			...
			//在页面加载完毕后，默认在工作区中自动打开workbench/main/index.jsp页面
		...
		<ul id="no1" class="nav nav-pills nav-stacked">
			...
			<li class="liClass">
				...
				<ul id="no2" class="nav nav-pills nav-stacked collapse">
					...
					<li class="liClass"><a href="workbench/chart/transaction/toChartTranIndex.do" target="workareaFrame">&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-chevron-right"></span> 交易统计图表</a></li>
				</ul>
			</li>

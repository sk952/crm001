...
<head>
	...
	<script type="text/javascript">
		...
		function updateStage(listStage,i) {
			...
			/*
                ...
                如果仅仅只是修改阶段，那么为后台传递stage和id即可

                但是在我们修改了阶段之后，需要伴随着生成一条交易历史

                为了记录交易历史，该得为后台传递money和expectedDate
			...
			$.ajax({
				...
				url : "workbench/transaction/updateTranStage.do",
				data : {
		...
		function changeIcon(listStage,index1) {
			...
			/*
                ...
                由于图标可以随意点击，所以所有的图标应该更新成什么样式及颜色，都需要重新的进行判断

             */

			//如果当前阶段可能性为0 前7个一定是黑圈，后面两个一个是红叉，一个是黑叉
...
<div style="position: relative; left: 40px; top: -50px;">
	阶段&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<%--<span class="glyphicon glyphicon-ok-circle mystage" data-toggle="popover" data-placement="bottom" data-content="资质审查123" style="color: #90F790;"></span>
    -----------
	...
	<%
		...
		if("0".equals(currentPossibility)){
			...
			for(int i=0;i<dvList.size();i++){
				...
				//如果遍历出来的阶段的可能性为0，说明遍历出来的阶段一定是后两个阶段
	...
	<span id="<%=i%>" onclick="updateStage('<%=listStage%>','<%=i%>')"
